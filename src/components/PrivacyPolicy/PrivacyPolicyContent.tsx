    ...
    <>
      <div className="py-[50px] md:py-[60px] lg:py-[80px] xl:py-[100px]">
        <div className="container mx-auto px-[15px]">
          <p className="text-[14px] md:text-[15px] text-[#4c4c4c] leading-[1.7] mb-[15px] last:mb-0">
            Last updated on September 25, 2023.
          </p>
          <p className="text-[14px] md:text-[15px] text-[#4c4c4c] leading-[1.7] mb-[15px] last:mb-0">
            Hi there, we’re <strong className="text-black">Adla</strong>, and
            welcome to our privacy policy which also applies to our customers.
            <br />
            This policy sets out how we handle your personal information if
            you’re an <strong className="text-black">Adla</strong> user or
            visitor to our site.
          </p>
          <p className="text-[14px] md:text-[15px] text-[#4c4c4c] leading-[1.7] mb-[15px] last:mb-0">
            When we say ‘we’, ‘us’, or ‘
            <strong className="text-black">Adla</strong>’, it’s because that’s
            who we are and we own and run the site.
            <br />
          ...
          <h3 className="font-bold  text-[20px] md:text-[22px] lg:text-[24px] leading-[1.3] mb-[15px]">
          ...
          <p className="text-[14px] md:text-[15px] text-[#4c4c4c] leading-[1.7] mb-[15px] last:mb-0">
            ...
            and deliver products/information and other marketing elements.
            Visitors aren’t allowed to purchase any product or subscribe to the
          ...
          <p className="text-[14px] md:text-[15px] text-[#4c4c4c] leading-[1.7] mb-[15px] last:mb-0">
            ...
            modifying your browser <i>preferences</i>, you can accept all
            cookies, be notified when a cookie is set, or reject all cookies. If
            you reject cookies, some parts of our site may not work properly in
            your case.
          </p>
          ...
          <p className="text-[14px] md:text-[15px] text-[#4c4c4c] leading-[1.7] mb-[15px] last:mb-0">
            ...
            visitors’ IP and time of visits.{" "}
            <strong className="text-black">Adla</strong> visitors who do not
            wish to have cookies placed on their browsers should set their
            browsers to refuse cookies before using the{" "}
            <strong className="text-black">Adla</strong> site.
          </p>
          ...
          <p className="text-[14px] md:text-[15px] text-[#4c4c4c] leading-[1.7] mb-[15px] last:mb-0">
            ...
            information or to provide you with the{" "}
            <strong className="text-black">Adla</strong> services, you can
