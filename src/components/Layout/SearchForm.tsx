    ...
    <>
      <form className="search-form xl:w-[180px] 2xl:w-[230px]">
        <label className="relative block">
          <input
            className="block bg-[#F2F2F8] w-full rounded-full py-[14px] pl-[30px] pr-[45px] rtl:pr-[20px] rtl:pl-[45px] placeholder:text-[#4C4C4C] focus:outline-none"
          ...
          <button
            type="submit"
            className="absolute inset-y-0 right-[20px] rtl:right-auto rtl:left-[20px] flex items-center"
          >
            <svg
