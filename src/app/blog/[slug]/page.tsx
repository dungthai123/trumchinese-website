...
import { getBlogPost, getBlogPosts, getCategories, getFeaturedImageUrl, getAuthor } from '@/lib/wordpress';
...
export default async function BlogPostPage({ params }: BlogPostPageProps) {
  ...
  const [categories, { posts: recentPosts }, author, featuredImage] = await Promise.all([
    getCategories(),
    getBlogPosts(1, 5),
      ...
      <article className="bg-white">
        ...
        <div className="relative">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className={`${featuredImage ? 'absolute bottom-8 left-4 right-4' : 'py-16'}`}>
              <div className={`${featuredImage ? 'text-white' : 'text-gray-900'}`}>
                {/* Breadcrumb */}
                <nav className="mb-4">
                  <ol className="flex items-center space-x-2 text-sm">
                    <li>
                      <Link 
                        href="/" 
                        className={`hover:underline ${featuredImage ? 'text-blue-200' : 'text-blue-600'}`}
                      >
                        Trang chủ
                      </Link>
                    </li>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2">
                <div className="bg-white rounded-lg shadow-sm p-8 md:p-12">
                  ...
                  {post.excerpt && (
                    <div 
                      className="text-xl text-gray-600 italic border-l-4 border-blue-500 pl-6 mb-8"
